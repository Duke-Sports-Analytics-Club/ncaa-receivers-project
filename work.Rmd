...
lines(roc_pre, col = "red")
lines(roc_post, col = "green")
legend("bottomright",legend=c("Model 1","Model 2","Model 3"),pch=15,col=c("blue","red",'green'))
```
...
pred_coll <- as.integer(pred_coll > 0.5)
...
pred_coll_2 <- as.integer(pred_coll_2 > 0.5)
...
pred_coll_3 <- as.integer(pred_coll_3>0.5)
