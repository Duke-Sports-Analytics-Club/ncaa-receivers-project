...
legend("bottomright",legend=c("All Stats Model","Totals Model","Seasons Model"),pch=15,col=c("blue","red","green"))
```
...
legend("bottomright",legend=c("All Stats Model","Seasons Model","Totals Model"),pch=15,col=c("blue","red",'green'))
```
