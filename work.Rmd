...
**For each model from 1 to 2 I removed grades-hands-fumble, total_yards_per_reception, total_first_downs, total_route_percent, grades_pass_route**
...
snap_model_coll_df3 <- snap_model_coll_df %>% 
  select(total_yards, total_catch_percent, total_target_percent, total_drop_percent, total_yprr, total_yards_after_catch_per_reception, total_player_game_count, total_touchdowns, total_yards_per_game, total_targets_per_game, total_targeted_qb_rating, games_draft, grades_hands_drop, grades_offense, Power5_draft, playedA_Yr)
index<-createDataPartition(snap_model_coll_df2$playedA_Yr,p=0.7,list=FALSE)
...
great_starter_coll_df2 <- great_starter_coll_df %>% 
  select(total_yards, total_catch_percent, total_target_percent, total_route_percent, total_drop_percent, total_yprr, total_first_downs, total_yards_per_reception, total_yards_after_catch_per_reception, total_player_game_count, total_touchdowns, total_yards_per_game, total_targets_per_game, total_targeted_qb_rating, games_draft, grades_hands_drop, grades_hands_fumble, grades_offense, grades_pass_route, Power5_draft, greatStarter)
...
great_starter_coll_df2 <- glm(greatStarter~., data=train, family = "binomial")
summary(great_starter_coll_df2)
```
