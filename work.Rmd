...
full_data$contributor <- with(full_data, ifelse(pass_plays1yr > 200 | pass_plays1yr > 200, 1, 0))
```

```{r}
response_data <- full_data %>% 
  select(player_id, playedA_Yr, scoredTouchDown, decentStarter, greatStarter, eliteStarter, contributor)
```
