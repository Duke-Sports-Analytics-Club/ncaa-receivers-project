...
snap_model_coll_df <- college_data %>% 
  select(-c(player_id, player, position, team_name_draft, scoredTouchDown, decentStarter, greatStarter, eliteStarter, team_name_draft, team_name_pre))
```

```{r decent starter model}
decent_starter_coll_df <- college_data %>% 
  select(-c(player_id, player, position, team_name_draft, scoredTouchDown, playedA_Yr, greatStarter, eliteStarter, team_name_draft, team_name_pre))
```

```{r great starter}
great_starter_coll_df <- college_data %>% 
  select(-c(player_id, player, position, team_name_draft, scoredTouchDown, playedA_Yr, decentStarter, eliteStarter, team_name_pre))
```
