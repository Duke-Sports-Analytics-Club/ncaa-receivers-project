...
dc2021_stats2020 <- stats_2020 %>% 
  ...
  mutate(total_yards = yards_draft + yards_pre,
         ...
         total_yards_after_catch_per_reception = sum(c(yards_after_catch_per_reception_draft, yards_after_catch_per_reception_pre), na.rm = TRUE),
         ...
         total_yards_after_catch_per_game = ((sum(c(yards_after_catch_draft, yards_after_catch_pre), na.rm = TRUE)) / total_player_game_count), 
         ...
         grades_hands_drop = sum(c((games_draft*grades_hands_drop_draft),((1-games_draft)*grades_hands_drop_pre)), na.rm = TRUE),
         grades_hands_fumble = sum(c((games_draft*grades_hands_fumble_draft),((1-games_draft)*grades_hands_fumble_pre)), na.rm = TRUE),
         grades_offense = sum(c((games_draft*grades_offense_draft),((1-games_draft)*grades_offense_pre)), na.rm = TRUE),
         grades_pass_route = sum(c((games_draft*grades_pass_route_draft),((1-games_draft)*grades_pass_route_pre)), na.rm = TRUE))
