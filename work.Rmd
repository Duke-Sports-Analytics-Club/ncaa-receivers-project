...
```{r merge PFF data}
#2020 Stats
stats_2020 <- left_join(rec_2020, sch_2020, copy = FALSE, 
                          by = c("player", "position", "team_name",
                                 "player_game_count", "player_id",
                                 "declined_penalties", "franchise_id")) 

#2019 Stats
stats_2019 <- left_join(rec_2019, sch_2019, copy = FALSE, 
                          by = c("player", "position", "team_name", "player_game_count", "player_id", "declined_penalties", "franchise_id")) 

#2018 Stats
stats_2018 <- left_join(rec_2018, sch_2018, copy = FALSE, 
                          by = c("player", "position", "team_name",
                                 "player_game_count", "player_id",
                                 "declined_penalties", "franchise_id")) 

#2017 Stats
stats_2017 <- left_join(rec_2017, sch_2017, copy = FALSE, by = c("player", "position", "team_name", "player_game_count", "player_id", "declined_penalties", "franchise_id")) 


#2016 Stats
stats_2016 <- left_join(rec_2016, sch_2016, copy = FALSE, 
                          by = c("player", "position", "team_name",
                                 "player_game_count", "player_id",
                                 "declined_penalties", "franchise_id")) 
#2015 Stats
stats_2015 <- left_join(rec_2015, sch_2015, copy = FALSE, by = c("player", "position", "team_name", "player_game_count", "player_id", "declined_penalties", "franchise_id")) 
...
dc_2021 <- c("DeVonta Smith" , "Elijah Moore" , "Jaelon Darden" , "Dax Milne" , 
             "Austin Trammell" , "Marlon Williams" , "Tim Jones" , "Tylan Wallace" ,
             "D'Wayne Eskridge" , "Jonathan Adams Jr." , "Kadarius Toney" , 
             "Jaylen Waddle" , "Antonio Nunn" , "Dyami Brown" , "Rashod Bateman" ,
...
write.csv(joined_data, "full_data.csv", row.names = TRUE)
```
