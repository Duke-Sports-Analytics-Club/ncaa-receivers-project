...
snap_model_com <- combine_cleaned %>% 
  select(-c(player_id, player, position, team_name_draft, scoredTouchDown, decentStarter, greatStarter, eliteStarter, Power5_pre, Team, team_name_pre, games_draft))
```
...
decent_starter_com <- combine_cleaned %>% 
  select(-c(player_id, player, position, team_name_draft, scoredTouchDown, playedA_Yr, greatStarter, eliteStarter, Team, team_name_pre, Power5_pre, games_draft))
```
